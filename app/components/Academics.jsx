...
const Academics = ({isDarkMode}) => {
  return (
    ...
    >
      ...
      >
        {academicData.map(({semester, cgpa, courses}, index) => (
          <motion.div
          ...
          >
            <h3 className='text-lg my-4 text-gray-700 dark:text-white'>{semester}</h3>
            <div className='flex justify-between'>
              <div>
                <p className='text-sm text-gray-600 dark:text-white/80'>CGPA</p>
                <p className='font-bold text-blue-600 dark:text-blue-400'>{cgpa}</p>
              </div>
              <div>
                <p className='text-sm text-gray-600 dark:text-white/80'>Courses</p>
                <p className='font-bold text-green-600 dark:text-green-400'>{courses}</p>
              </div>
            </div>
          </motion.div>
        ))}
