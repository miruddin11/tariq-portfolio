...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "00bc03b5-4336-4a07-b729-985add149856");
  ...
  return (
    ...
    id='contact'className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat 
    bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I am always open to new opportunities and collaborations. Feel free to reach out to me if you have any questions or just want to say hi!
      </motion.p>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] 
